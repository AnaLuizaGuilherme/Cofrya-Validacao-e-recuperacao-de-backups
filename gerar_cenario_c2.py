"""C2: alteração de bytes após a criação (seção 4.4, Quadro 3 do TCC)."""
...
def main():
    parser = argparse.ArgumentParser(description="Gera um backup do cenário C2.")
    ...
    id_copia = f"pedidos_seed{args.semente}_c2"
    ...
    # SÓ AGORA altera bytes do arquivo — depois que o manifesto já capturou o estado íntegro.
    resultado = scenarios.adulterar_bytes(caminho_backup)
