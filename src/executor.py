...
def executar_tentativa(
    ...
    try:
        ...
        if configuracao == Configuracao.A:
            # A verifica apenas existência do arquivo e "sucesso informado" —
            # neste protótipo, a ausência de um marcador de falha do produtor.
        ...
        dentro_da_politica = idade <= timedelta(days=politica.idade_maxima_dias)
